...
namespace DemoFintechApp.API.Controllers
{
	...
	public class TransactionController : BaseController
	{
		...
		public async Task<IActionResult> GetAccountBalance([FromBody] GetAccountBalanceRequestDto request)
		{
		...
		[ProducesResponseType(200, Type = typeof(ApiResponse<CreditAccountResponseDto>))]
		[ProducesResponseType(404, Type = typeof(ApiResponse))]
		[ProducesResponseType(400, Type = typeof(ApiResponse))]
		public async Task<IActionResult> CreditAccount(string userId, CreditAccountRequestDto request)
		{
			ServiceResponse<CreditAccountResponseDto> response = await _transactionService.CreditAccountAsync(userId, request);
			return ComputeResponse(response);
		}
		...
		[ProducesResponseType(404, Type = typeof(ApiResponse))]
		[ProducesResponseType(400, Type = typeof(ApiResponse))]
		public async Task<IActionResult> DebitAccount(string userId, DebitAccountRequestDto request)
		{
